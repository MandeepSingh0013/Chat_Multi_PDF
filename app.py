...
def get_conversational_chain():
    ...
    if the answer is not avialble in provided context just say, "answer is not available in the context",
...
def main():
    ...
    with st.sidebar:
        st.title("Menu:")
        pdf_docs = st.file_uploader("Upload your PDF File and Click on the submit & Process")
